...
Examples [from Steven Pinker talk](https://www.youtube.com/watch?v=sS-Txm3R3v8)
...
Subjects were tested under conditions of good to excellent acoustic isolation.

- We tested the students tested in a quiet room. 

---

# What to do about zombie nouns and passive voice

- watch out for words that end in -tion -ment
- can you put "by zombies on the end of a phrase?
- insert other tell tale signs...
...
```{r echo=FALSE}
knitr::include_graphics("https://pgrdocblog.files.wordpress.com/2014/11/shut-up-and-write.jpg")
```
...
# Get used to the idea it won't sound good coming out of your head
