...
Slides...[https://jenrichmond.github.io/slides/lubridate#1](https://jenrichmond.github.io/slides/lubridate#1)
...
```{r echo=FALSE, out.width= "400px"}
knitr::include_graphics("img/smh.png")
```
...
.small[Tips: label = TRUE, week_start = getOption("lubridate.week.start", 1)]
...
Data that is in year-month-day format (ISO 8601) will always parse as dates
