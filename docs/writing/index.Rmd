...
knitr::include_graphics(here::here("img", "inspirationCH.jpg"))
```
...
knitr::include_graphics(here::here("img", "procrastination2.gif"))
```
...
knitr::include_graphics(here::here("img", "thegap.png"))
```
...
knitr::include_graphics(here::here("img", "blockCH.jpg"))
```
...
knitr::include_graphics(here::here("img", "writetolearn.jpeg"))
```
...
```{r echo=FALSE}
knitr::include_graphics(here::here("img", "abstract.png"))
```
...
### Oppenheimer I
```{r echo=FALSE}
knitr::include_graphics(here::here("img", "p1_2.png"))
```
...
### Oppenheimer II
```{r echo=FALSE}
knitr::include_graphics(here::here("img", "p3-4.png"))
```
...
```{r echo=FALSE}
knitr::include_graphics(here::here("img", "p1_2_p.png"))
```

---
```{r echo=FALSE}
knitr::include_graphics(here::here("img", "p3-4_p.png"))
```
...
```{r echo=FALSE, out.width= "700px"}
knitr::include_graphics(here::here("img", "SUAW.jpeg"))
```
